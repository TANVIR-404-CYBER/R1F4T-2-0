...
\33[1;37m----------------------------------------------
→   Owner      :  SADIA TANVIR 
→   Facebook   :  MOHAMMAD TANVIR
→   Github     :  TANVIR-404-CYBER
...
def menu():
			...
			if rifat in ['1','01']:
				...
				os.system('xdg-open https://www.facebook.com/NATOK.BAZ.TANVIR');menu()
			elif rifat in ['8','08']:
				exit('')
			else:
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[T4NV1R-OK] '+ids+' | '+pas+'\033[1;32m')
